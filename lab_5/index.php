...
[$has_errors, $birth_date] = validate_form(
    $fio,
    $phone,
    $email,
    $birth_date_input,
...
try {
    ...
    $stmt = $pdo->prepare('
        INSERT INTO applications (login, password_hash, fio, phone, email, birth_date, gender, biography, contract_accepted)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    ');
